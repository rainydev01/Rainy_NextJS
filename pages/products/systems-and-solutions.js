        ...
        <div className="App">
          ...
          <div className="container-fluid banner enternal ">
            <div className="hero-image enthroimg">
              <img src="../../static/images/systemsSolutions/systemsAndSolutionBanner.png" alt="rainwater harvesting system in india" />
          ...
          <div className="container-fluid wthothding backgroundDrops">
            <h2 class="whtdowdo">SYSTEMS & SOLUTIONS</h2>
            <div className="container">
              <div className="row">
                <div className="col-md-6">
                  ...
                  >
                    <img src="../../static/images/systemsSolutions/BigImage.JPG" alt="rainwater harvesting system in india" />
                  </div>
                </div>
                <div className="col-md-6">
