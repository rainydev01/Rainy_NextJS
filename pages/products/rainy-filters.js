									...
									<div className="techpointslst">
										<table class="table table-striped  table-bordered ">
    										<tbody>
    											...
    											<tr>
    												<td className="borderRig 					 										< 										<t 											<												<td>Less than 2 feet of head (0.060kg/cm2)</td>
    											</tr>
												<tr>
													<td className="borderRight">Capacity:</td>
													<td>340 LPM</td>
					...
					<div className="container-fluid fl500fltr">
						<div className="container">
    						<div className="row">
								...
								<div className="col-md-8">
									<i className="techpointslst">
										tble class="table table-striped  table-bordered ">
    										<tbody>
    											<tr>
    												<td style={{width: "40%"}} className="borderRight">
    													Suitable up to area:
											...
											/tr>
												...
												<tr>
													<td clasame="borderRight">Operating Pressure:</td>
    												<td>Less than 2 feet of head (0.060kg/cm2)</td>
												</tr>
												<tr>
													<td clasame="borderRight">Capacity:</td>
													<td>480LM</td>
    											</tr>
