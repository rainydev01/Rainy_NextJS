						...
						<div className="container">
							<div className="techhedng">
								...
								<p className="techpara">
									Lorum ipsum dolor sit amet, conseteture sadipscing elitr, set diam nonumy. Lorum
									ipsum dolor sit amet, conseteture sadipscing elitr, set diam nonumy Lorum ipsum
									dolor sit amet, conseteture sadipscing elitr, set diam nonumy, conseteture
									sadipscing elitr, set diam nonumy.
								</p>
							</div>
							<div className="row">
									...
									<div className="techpointslst">
										<ul>
											...
											<li>
												...
												/>
												Rain water is one of the purest source of water with less then 50mg/
												litre of total Dissolved Solids (TDS).Rain water is one of the purest
												source of water with less then 50mg/ litre of total Dissolved Solids
												(TDS).
											</li>
											<li>
												<img
										...
										<div className="techaccrdn">
											...
											>
												<div className="card-body">
													Lorum ipsom is a dummy text, Here is a text is only for test. Lorum
													ipsom is a dummy text, Here is a text is only for test. Lorum ipsom
													is a dummy text, Here is a text is only for test. Lorum ipsom is a
													dummy text, Here is a text is only for test.
