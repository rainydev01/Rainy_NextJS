          ...
          <div className="container">
            ...
            <div className="blog-content">
              ...
              <div className="blog-info">
                ...
                <p>
                <h5>Level 1: Gutter Guards:</h5> Removes large debris and dirt that are collected from your roof. To prevent clogging, leaf decay, and built of bacteria, it is essential to screen the leaf substances on a regular basis. 
                </p>
                <p>
                  <h5>
                  Level 2: First Flush Diverter:
                  </h5>
                ...
                <p>
                  ...
                  The overflow skimmer is the first point at which rainwater enters the tank, which benefits the catchment system. Overflow skimmer removes the finest surface contaminants from the tank and simultaneously overflow siphons keep the tank from overflowing. This layer will give you a clean water zone and intake for the next layer.
                </p>
                <p>
                  <h5>Level 4: Floating Extractor:</h5>
                  The floating extractor is designed to extract water from the cleanest zone of rainwater. This zone in the storage tank is about 4 inches below the top of the water. This is preferable to drawing water from the tank's bottom, where heavy sediment settles, and it also avoids small skimming particles from the top.
                </p>
                <p>
                  <h5>Level 5: Spin down Filter:</h5>
                  The Spin down Filter uses the quantity of motion, mass, and velocity of the water to throw particles out of the stream, which settles in the lowest area of the filter. The spin-down gets effortlessly rinsed through the bottom valve, which can be back-flushed, and used over and over again. It does not require extensive maintenance or replacement filters, extending the life of subsequent canister filters.
                </p>
                <p>
                  <h5>Level 6: Filter Canister:</h5>
                  Filter Canister is 5, 10, and 20 microns. This assists the next layer in the structure and the ceramic filter in remaining clean. The filter size and input quality must be changed on a regular basis, depending on the maintenance to be performed.
                </p>
                <p>
                  <h5>Level 7: Ceramic Filter:</h5>
                  The ceramic filter puts a considerably intense clean finish on the water setup. Before entering, it should be filtered to 5 microns, which means less cleaning and fewer chances of breaking the ceramic candles.
                </p>
              </div>

            <div className="blog-info">
              <h3>
              Rainy Self-cleaning Roof Top Filter System
              </h3>
              <p>
              ...
              <div className="blogImg hero-image enthroimg" style={{width:"500px",display:"flex",justifyContent:"center"}}>
                <img
