								...
								<div className="sec-brdr">
									...
									<div className="mdiacont">
										<div className="grndtext">
											<h3>
												<a href="google.com">
													Farmland Rainwater Harvesting Systems Wins Aqua Foundations
													Excellence Award. 1
												</a>
											</h3>
											<p
											...
											>
												Lorum ispum is a dummy text for web. Lorum ispum is a dummy text for
												web. Lorum ispum is a dummy text for web. Lorum ispum is a dummy text
												for web.{' '}
											</p>
									...
									<div className="mdiacont">
										<div className="grndtext">
											...
											>
												Lorum ispum is a dummy text for web. Lorum ispum is a dummy text for
												web. Lorum ispum is a dummy text for web. Lorum ispum is a dummy text
												for web. Lorum ispum is a dummy text for web.
											</p>
											<div className="mdiasocial">
												<div className="col-md-6 mediasocial">
													<i className="fa fa-facebook" aria-hidden="true" />
