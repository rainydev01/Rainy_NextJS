          ...
          <div className="container-fluid techbgmain">
            <div className="container">
              <div className="techhedng">
                  <h2 className="tech-heading">Rainwater Harvesting Projects </h2>
                  ...
                  <ul style={{ "listStyleType" : "disc" }}>
                      <li>
                          <p><span>Saving Water: </span> When we harvest rainwater, we use less water from rivers and underground sources. This helps keep important water resources safe.</p>
                      </li>

                      <li>
                          <p><span>Helping in Dry Times: </span> When there's not enough rain and things get dry, rainwater projects give us another source of water. This helps us have enough water even when there's a drought or when water is hard to find.</p>
                      </li>

                      <li>
                          <p><span>Stopping Flooding: </span> Sometimes, when it rains a lot, water can flood the streets. Rainwater projects catch that extra water and stop flooding, especially in places with lots of buildings and concrete.</p>
                      </li>

                      <li>
                          <p><span>Saving Money and Nature: </span> Rainwater projects are not expensive to take care of. Plus, they help us use rainwater instead of paying a lot to clean and pump water. This is good for the environment too.</p>
                      </li>
                  ...
                  <ul style={{ "listStyleType" : "disc" }}>
                      <li>
                          <p><span>Figuring Out Rain and Water Needs: </span> First, we look at how much it usually rains and how much water we need. This helps us know how much rainwater we can collect and use.</p>
                      </li>

                      <li>
                          <p><span>Planning the Right Way: </span> We need to design a good place to catch rainwater and a system to store it. This could be things like putting pipes to catch the rain, having a big tank to store it, and even ways to clean the water.</p>
                      </li>

                      <li>
                          <p><span>Setting Up the Right Stuff: </span> To catch rainwater, we need to put special pipes and things like gutters on the roof. These help guide the rain into the storage tank. Also, we need to have things that clean the water a bit, like filters.</p>
                      </li>

                      <li>
                          <p><span>Taking Care of It: </span> Rainwater systems need to be looked after. This means checking them sometimes to make sure nothing is blocked, like the pipes or filters. If we do this, the system works well.</p>
                      </li>

                      <li>
                          <p><span>Teaching People How to Use It Well: </span> Lastly, it's important to show people how to use the rainwater in a good way. This makes sure we don't waste it and use it wisely.</p>
                      </li>
                  </ul>
              ...
              <div className="techhedng">
                ...
                <div>
                  <ul style={{ "listStyleType" : "number" }}>
                      ...
                      <li>
                          <p><span style={{ "textDecoration" : "underline" }}>Surface Runoff Harvesting: </span> This technique focuses on directing rainwater from open spaces like roads, driveways, and small catchment areas into storage systems. It's particularly useful in areas with gentle slopes where surface runoff can be effectively managed.</p>

                      </li>

                      <li>
                          <p><span style={{ "textDecoration" : "underline" }}>Stormwater Harvesting: </span> In urban environments, stormwater often carries pollutants and contributes to flooding. Harvesting and treating this rainwater can alleviate flooding and provide a new water source. It involves designing systems to collect, treat, and store stormwater for various uses.</p>

                      </li>

                      <li>
                          <p><span style={{ "textDecoration" : "underline" }}>Green Roof Harvesting: </span> Green roofs involve growing plants on building rooftops, which absorb rainwater and release it slowly. This method combines rainwater harvesting with environmental benefits like improving air quality and reducing heat in cities.</p>
                      ...
                      <li>
                          <p><span style={{ "textDecoration" : "underline" }}>Combined Rainwater Harvesting: </span> This approach involves integrating multiple methods to optimize rainwater collection. For example, combining rooftop and surface runoff harvesting allows for a comprehensive solution tailored to the specific site conditions.</p>

                      </li>

                      <li>
                          <p><span style={{ "textDecoration" : "underline" }}>Community Rainwater Harvesting: </span> Larger-scale projects are designed for communities or clusters of buildings. These projects often involve advanced rainwater collection and distribution systems to provide water for multiple households or public facilities.</p>
              ...
              <div className="techhedng">
                  ...
                  <div>
                      ...
                      <p><span style={{ "textDecoration" : "underline" }}>Ans:</span> Yes, Rainwater harvesting can be implemented in urban areas. The most common technique used in urban areas is rooftop rainwater harvesting.</p>
                  </div>

                  <div>
                      <p style={{ "fontSize" : "0.90rem" }}>2.	What can rainwater harvesting be used for?</p>
                      <p><span style={{ "textDecoration" : "underline" }}>Ans:</span> Harvested rainwater can be used for irrigation, flushing toilets, washing cars, and even for drinking purposes after purification.</p>
                  </div>

                  <div>
                      <p style={{ "fontSize" : "0.90rem" }}>3.	Is rainwater safe for drinking?</p>
                      <p><span style={{ "textDecoration" : "underline" }}>Ans:</span> Raw rainwater is not typically considered safe for drinking without proper purification treatment. However, with proper filtration and disinfection methods it can be used for drinking.</p>
                  </div>

                  <div>
                      <p style={{ "fontSize" : "0.90rem" }}>4.	Do rainwater harvesting system require a lot of space?</p>
                      <p><span style={{ "textDecoration" : "underline" }}>Ans:</span> No, the rainwater harvesting system can be customized to fit the available space. It can be designed to suit individual houses, industries, apartments and government projects.</p>
                  </div>

                  <div>
                      <p style={{ "fontSize" : "0.90rem" }}>5.	Are rainwater harvesting projects economically viable?</p>
                      <p><span style={{ "textDecoration" : "underline" }}>Ans:</span> Yes, rainwater harvesting projects help in achieving long-term economic benefits by reducing water bills. It is a cheap and affordable method of water conservation.</p>
                  </div>
