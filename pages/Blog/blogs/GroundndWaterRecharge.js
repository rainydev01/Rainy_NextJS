				...
				<div className='App'>
					...
					<div className='container'>
						...
						<div className='content'>
							...
							<p>In recent years, there is a raised concern about meeting our own needs without compromising the ability of future generations to meet their own needs. There comes a demand for water consumption to fulfil increasing residential and irrigation demands. Nevertheless, with the help rainwater harvesting techniques there comes the chance to make it possible to maintain and increase the levels of depleting groundwater resources.
							</p>	
							<div className='content'>
                                    <h2>Ground water recharge methods</h2>
                                    <p>Groundwater recharge is a process, where water seeps down from the surface of the earth and gets collected in aquifers. So, the process is also known as deep percolation or recharging the ground water table.</p>
								...
								<div className='content'>
									...
									<ul>
										<li>
											...
											<p>The surface infiltration system is a method of spreading the water which is excess on the surface and makethe water to seep into the ground. This technique is possible in areas where the soil is permeable to allow water to pass through it.</p>
										</li>
                                        <p>There are two ways</p>
										<li>
											<p>a. In-channel systems: In-channel systems function by spreading the water over a larger area making it easier for infiltration process using dams, L or T-shaped levees and small-size weirs.</p>
										</li>
										<li>
											<p>b. Off-channel systems: Off-channel systems has gravel-pits and infiltration basins.</p>
										</li>
									</ul>
                                    <p>
								...
								<div className='content'>
                                    ...
                                    <ul>
                                             <li>
                                                    <p>1. Groundwater resource must be carefully protected and limited from irrational use and pollution. </p>
                                             </li>
                                              <li>
                                             <p> 2. Ground water recharge can support lives in a wide range of physical social and economic factors of the environment.</p>
                                             </li>
                                            <li>
                                           <p> 3. Artificial groundwater recharge is a significant measure apart from time that nature takes to fill up the ground water table by absorbing and filtering surface water.</p>
                                            </li>
                                            <li>
                                            <p> 4. Protecting groundwater is one of the main problems in the planet earth which also contributes in protecting the natural environment.</p>
                                            </li>
                                            <li>
                                           <p> 5. The water conservation measures would be the future of water with an all-time demand for water. </p>
                                            </li>
                                            <li>
                                            <p>6. Ground water recharge is a key or a way-out measure, which fill up aquifers. </p>
                                            </li>
                                            <li>
                                           <p> 7. Including the upstream and downstream userscould work together to maintain a healthy water cycle through “forest protection, reforestation, and improved agricultural practices.”</p>
                                            </li>
                                            <li>
                                           <p> 8. Groundwater recharge allows compensating or rather offsetting the negative impacts of unsustainable water use.</p>
                                            </li>
                                    </ul>
                                </div>
                                <div className='content'>
                                    ...
                                    <ul>
                                             <li>
                                                    <p>1. Aquifer depletion happens with the withdrawal of ground water for drinking, irrigation, industrial and other human uses than is naturally replaced. </p>
                                             </li>
                                              <li>
                                             <p> 2. Lower groundwater level affects agricultural and municipal water usage.</p>
                                             </li>
                                            <li>
                                           <p> 3. Recharge of ground water table can help reverse the cycle.</p>
                                            </li>
                                            <li>
                                            <p> 4. Removal of water from the soil, the land may drop as the soil compacts and cannot support the land above.
</p>
                                            </li>
                                            <li>
                                           <p> 5. The usage of water for agricultural purpose contributes up to 50 billion gallons of groundwater on daily basis.</p>
                                            </li>
                                            <li>
                                            <p>6. Over utilization of waterwould result in dry wells, lack of water quality.  </p>
                                            </li>
                                            <li>
                                           <p> 7. In water cycle, groundwater recharge would take place through precipitation and natural replenishment. This happens when there is a natural equilibrium. At the present-day situation, this might not the case.Climate change drastically alter the water cycle, causing reduced precipitation than normal.</p>
                                            </li>
                                            <li>
                                           <p> 8.Lower water table brings a condition that wells need to be drilled deeper.</p>
                                           <li>
                                            <p>
