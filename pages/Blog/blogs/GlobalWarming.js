				...
				<div className='App'>
					...
					<div className='container'>
						...
						<div className='content'>
							...
							<p>Climate is associated with sun, oceans, wind, rain, snow, forests, deserts, savannas, and human activity.<br></br>
								Increase in temperature of the earth’s atmosphere because an increased amount of the heat striking the earth from the sun that is being trapped in the earth’s atmosphere and cannot be radiated out into space is called global warming.<br></br>
								Climate change cause droughts and floods and affect water usage around the world. Global warming is one of the main reasons that is contributing to this problem. Because of the rise in temperature freshwater glaciers in some parts of the earth begin to melt resulting in rising sea levels.<br></br>
								Thetemperature change alters wind pattern that brings monsoons causing drought, also unpredictable weather, water availability, exacerbating water scarcity. <br></br>
							...
							<div className='content'>
								<ul>
									...
									<p>Human activity is the main factor that causes global warming. Due to pollution caused by industries the emission of carbon dioxide and greenhouse gas has raised the global temperature, as a result glaciers meltdown rapidly causing rise in sea level. This in turn elevates storm, increases coastal erosion and brings hurricanes and typhoons in the ocean.</p>
									<li>
									Droughts and heat waves
									</li>
									<p>
									Apart from downpours, droughts and a prolonged period of abnormally hot weather will become common. Yet, hot, dry places will get hotter and drier, and areas that once had regular rainfall will become much hotter and arid.
									</p>
									<li>
									Changing ecosystems
									</li>
									<p>
									Temperature change, that is rise in temperature level have effects on some staple crops. Farmers in temperate zones are finding dry conditions which are difficult for crops such as corn and wheat, and once prime growing zones are now threatened.
									Migration takes place among animals and fish species due to the temperature change in their own environment. The fish species migrates longer distance in the water.
									</p>
									<li>	
									Reduced food security
									</li>
									<p>
									Global agriculture gets affected from global warming. Productivity changes significantly due to temperature change, different crops are grown at specific temperature and when those temperatures change, it would bring changes in productivity.
									</p>
									<li>
									Heavy rainfall and storms
									</li>
									<p>
									Heavy rainfall occurs due to higher level of atmospheric water vapor, water evaporates in larger amounts, and this would lead to heavy downpours. Torrential rain leading to flooding will become more common. Hurricanes and typhoons will be intense.
									</p>
									<li>
									Melting Ice
									</li>
									<p>
									In addition to industrial revolution, carbon dioxide and other greenhouse gas emission human activities are the root cause for melting of glaciers. The rise in global temperature leads to increase of temperature even at poles resulting in rapid melting, calving into the sea and retreating to land with the rise of sea levels.
									</p>
								</ul>
								</div>	
								...
								<div className='content'>
									...
									<ul>
										<li>
											<p>Demand of water going beyond the available amount of water at a certain period called water stress. Climate change will lead to water shortage.</p>
										</li>
										<li>
											<p>Climate change modifies the volume of water required to satisfy everyday needs of human. Rise in temperature and the rate of evaporation increases the demand for water in some places.</p>
										</li>
										<li>
											<p>Destruction of vegetation worsenssoil erosion and lowers groundwater table and increase the demand for water and food.</p>
										</li>
										<li>
											<p>The need of energy for pumping, treatment, transportation is been increased as the demand for water increases and contributes to depletion of peat lands, the carbon sinks.</p>
										</li>
