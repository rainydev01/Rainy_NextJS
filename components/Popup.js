...
const Popup = () => {
    ...
    useEffect(() => {
        ...
        if (lastPopupShownDate !== currentDate) {
            ...
            // localStorage.setItem('lastPopupShownDate', '2024-04-05');
        }
    }, []);
                ...
                <div style={contentStyles}>
                    ...
                    <div style={{ display: 'flex' }}>
                        <div className='image-section'>
                            <img src="../static/images/contact-form.png" alt="" style={{ height: '100%' }} />
                        </div>
                        <div className="form-section">
                            <div className='colseBtn'>
                                <button style={closeButtonStyles} onClick={closePopup}>
                                    &times;
                                </button>
                            </div>
