        	...
        	<div style={{ backgroundImage: "url(../static/images/homepage/ddropsbg.png)", backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundPosition: "top left", }} >
              ...
              <div className="container media-main">
              			...
              			<div className="sec-brdr">
                			...
                			<div className="mdiacont">
                  				<div className="grndtext">
                    				<h3>
                      					<a href="/about-us/blogs/water-conservation-systems-usa" target="_self" >
										            Use Smart Water Conservation Systems USA from the House of Rainy Filters
                        				<br />
                      					</a>
                    				</h3>
                    				
                            <p style={{ textAlign: "left", color: "#4c3f43", fontSize: "13px", fontWeight: "500", letterSpacing: "0.5px", }} >
									          With 2.2 million people in the USA lacking safe drinking water, it’s time to start making use of best water conservation systems USA...
                            </p>

                    				<div className="col-md-12 mdiasocial">
                      					<div className="col-md-6 mediasocial">
                        					<FacebookShareButton url={ "https://www.rainyfilters.com/about-us/blogs/water-conservation-systems-usa" } >
                          						<i className="fa fa-facebook" aria-hidden="true" />
                        					</FacebookShareButton>

                        					<TwitterShareButton url={ "https://www.rainyfilters.com/about-us/blogs/water-conservation-systems-usa" } >
                          						<i className="fa fa-twitter" aria-hidden="true" />
                        					</TwitterShareButton>

                        					<WhatsappShareButton url={ "https://www.rainyfilters.com/about-us/blogs/water-conservation-systems-usa" } >
                  ...
                  <div className="col-md-4" style={{ marginTop: "30px" }}>
              			<div className="sec-brdr">
                			<div className="mdiaimg">
                  				<img src="../static/images/blogs/5_methods_of_water_conservation_inner1.jpg" style={{ height: "196px", }} />
                			</div>
                			<div className="mdiacont">
                  				<div className="grndtext">
                    				<h3>
                      					<a href="/about-us/blogs/5-methods-of-water-conservation" target="_self" >
										            5 Methods of Water Conservation: How Rainy Filters is Playing Its Part?
                        				<br />
                      					</a>
                    				</h3>
                    				
                            <p style={{ textAlign: "left", color: "#4c3f43", fontSize: "13px", fontWeight: "500", letterSpacing: "0.5px", }} >
									          Do you know that 30% to 60% of domestic drinking water goes into watering gardens and yards, and a large portion is wasted due to evaporation...
                            </p>

                    				<div className="col-md-12 mdiasocial">
                      					<div className="col-md-6 mediasocial">
                        					<FacebookShareButton url={ "https://www.rainyfilters.com/about-us/blogs/5-methods-of-water-conservation" } >
                          						<i className="fa fa-facebook" aria-hidden="true" />
                        					</FacebookShareButton>

                        					<TwitterShareButton url={ "https://www.rainyfilters.com/about-us/blogs/5-methods-of-water-conservation" } >
                          						<i className="fa fa-twitter" aria-hidden="true" />
                        					</TwitterShareButton>

                        					<WhatsappShareButton url={ "https://www.rainyfilters.com/about-us/blogs/5-methods-of-water-conservation" } >
                          						<i className="fa fa-whatsapp" aria-hidden="true" />
                        					</WhatsappShareButton>
                      					</div>
                      					<div className="col-md-6 mediabtn">
                  ...
                  <div className="col-md-4" style={{ marginTop: "30px" }}>
              			<div className="sec-brdr">
                			<div className="mdiaimg">
                  				<img src="../static/images/blogs/rainwater_harvesting_for_irrigation_inner1.jpg" style={{ height: "196px", }} />
                			</div>
                			<div className="mdiacont">
                  				<div className="grndtext">
                    				<h3>
                      					<a href="/about-us/blogs/rainwater-harvesting-for-irrigation" target="_self" >
										            Learn About Rainwater Harvesting for Irrigation from the Experts at Rainy Filters
                        				<br />
                      					</a>
                    				</h3>
                    				
                            <p style={{ textAlign: "left", color: "#4c3f43", fontSize: "13px", fontWeight: "500", letterSpacing: "0.5px", }} >
									          With intensive agriculture spreading throughout India there is this urgent need to encourage rainwater harvesting for irrigation. The greatest benefit of this system...
                            </p>

                    				<div className="col-md-12 mdiasocial">
                      					<div className="col-md-6 mediasocial">
                        					<FacebookShareButton url={ "https://www.rainyfilters.com/about-us/blogs/rainwater-harvesting-for-irrigation" } >
                          						<i className="fa fa-facebook" aria-hidden="true" />
                        					</FacebookShareButton>

                        					<TwitterShareButton url={ "https://www.rainyfilters.com/about-us/blogs/rainwater-harvesting-for-irrigation" } >
                          						<i className="fa fa-twitter" aria-hidden="true" />
                        					</TwitterShareButton>

                        					<WhatsappShareButton url={ "https://www.rainyfilters.com/about-us/blogs/rainwater-harvesting-for-irrigation" } >
                          						<i className="fa fa-whatsapp" aria-hidden="true" />
                        					</WhatsappShareButton>
                      					</div>
                      					<div className="col-md-6 mediabtn">
              ...
              <div className="container media-main" style={{ marginTop: "10vh" }}>
                  ...
                  <div className="col-md-4" style={{ marginTop: "30px" }}>
              			<div className="sec-brdr">
                			<div className="mdiaimg">
                  				<img src="../static/images/blogs/rain_water_harvesting_in_the_uk_inner1.png" style={{ height: "196px", }} />
                			</div>
                			<div className="mdiacont">
                  				<div className="grndtext">
                    				<h3>
                      					<a href="/about-us/blogs/rain-water-harvesting-in-the-uk" target="_self" >
										            Understanding the Main Components of Rain Water Harvesting in the UK
                        				<br />
                      					</a>
                    				</h3>
                    				
                            <p style={{ textAlign: "left", color: "#4c3f43", fontSize: "13px", fontWeight: "500", letterSpacing: "0.5px", }} >
									          Increasing population, lack of advanced infrastructure and climate breakdown are significant factors contributing to water scarcity in the UK...
                            </p>

                    				<div className="col-md-12 mdiasocial">
                      					<div className="col-md-6 mediasocial">
                        					<FacebookShareButton url={ "https://www.rainyfilters.com/about-us/blogs/rain-water-harvesting-in-the-uk" } >
                          						<i className="fa fa-facebook" aria-hidden="true" />
                        					</FacebookShareButton>

                        					<TwitterShareButton url={ "https://www.rainyfilters.com/about-us/blogs/rain-water-harvesting-in-the-uk" } >
                          						<i className="fa fa-twitter" aria-hidden="true" />
                        					</TwitterShareButton>

                        					<WhatsappShareButton url={ "https://www.rainyfilters.com/about-us/blogs/rain-water-harvesting-in-the-uk" } >
                          						<i className="fa fa-whatsapp" aria-hidden="true" />
                        					</WhatsappShareButton>
                      					</div>
                      					<div className="col-md-6 mediabtn">
                  ...
                  <div className="col-md-4" style={{ marginTop: "30px" }}>
              			<div className="sec-brdr">
                			<div className="mdiaimg">
                  				<img src="../static/images/blogs/rainwater_collection_inner1.jpg" style={{ height: "196px", }} />
                			</div>
                			<div className="mdiacont">
                  				<div className="grndtext">
                    				<h3>
                      					<a href="/about-us/blogs/rainwater-collection" target="_self" >
										            How to Use Rainwater Collection System for Fresh Water?
                        				<br />
                      					</a>
                    				</h3>
                    				
                            <p style={{ textAlign: "left", color: "#4c3f43", fontSize: "13px", fontWeight: "500", letterSpacing: "0.5px", }} >
									          With the Indian population facing major water scarcity and reports suggesting that 1.7 to 2.4 billion people will be living in water-stressed...
                            </p>

                    				<div className="col-md-12 mdiasocial">
                      					<div className="col-md-6 mediasocial">
                        					<FacebookShareButton url={ "https://www.rainyfilters.com/about-us/blogs/rainwater-collection" } >
                          						<i className="fa fa-facebook" aria-hidden="true" />
                        					</FacebookShareButton>

                        					<TwitterShareButton url={ "https://www.rainyfilters.com/about-us/blogs/rainwater-collection" } >
                          						<i className="fa fa-twitter" aria-hidden="true" />
                        					</TwitterShareButton>

                        					<WhatsappShareButton url={ "https://www.rainyfilters.com/about-us/blogs/rainwater-collection" } >
                          						<i className="fa fa-whatsapp" aria-hidden="true" />
                        					</WhatsappShareButton>
                      					</div>
                      					<div className="col-md-6 mediabtn">
